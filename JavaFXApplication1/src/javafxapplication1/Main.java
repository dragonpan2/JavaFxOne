...
//        writeProdctDataFile(productListMaster);
    ...
    public void writeUserDataFile (UserList userListMaster) {
        try {
    ...
    public void writeProdctDataFile (ProductList productListMaster) {
        try {
    ...
    public void readProductDataFile(ProductList productListMaster) {
        try {
    ...
    public void readUserDataFile(UserList userListMaster) {
        try {
    ...
    public void addNewProduct(ProductList productListMaster, String productCode, String productName, double price, int quantityToAdd) {
    ...
    public void addNewProduct(ProductList productListMaster, String productCode, String productName, double price) {
        Product newProduct = new Product();
        newProduct.setProductCode(productCode);
        newProduct.setProductName(productName);
        newProduct.setPrice(price);
    ...
    public void addNewUser(UserList userListMaster, String idBarcode, String name, double balance ) {
